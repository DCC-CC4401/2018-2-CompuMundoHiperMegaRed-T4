# Generated by Django 2.1.3 on 2018-11-27 00:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('Pendiente', 'pendiente'), ('Contestada', 'contestada')], default='pendiente', max_length=14)),
                ('alumno_a_evaluar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('alumno_evaluador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('coevaluacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Coevaluacion')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
        ...
        migrations.AddField(
            ...
            name='grupo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Grupo'),
        ),
        migrations.AddField(
            model_name='asignacion',
            name='integrante',
